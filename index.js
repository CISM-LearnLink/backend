...
parentRouter.get(
  ...
  auth,
  parentController.getTutorReviews,
);
...
parentRouter.get(
  "/tutor/:tutorId/busy-times",
  auth,
  parentController.getTutorBusyTimes,
);
parentRouter.get(
  "/all-tutors/busy-times",
  auth,
  parentController.getAllTutorsBusyTimesForParent,
);
...
parentRouter.post(
  "/recently-visited",
  auth,
  parentController.markRecentlyVisited,
);
...
parentRouter.get(
  "/bookings-for-dispute",
  auth,
  parentController.getBookingsForDispute,
);
parentRouter.post("/disputes", auth, parentController.createDispute);
parentRouter.get(
  "/disputes/:disputeId",
  auth,
  parentController.getDisputeDetails,
);
parentRouter.post(
  "/disputes/:disputeId/message",
  auth,
  parentController.addDisputeMessage,
);
parentRouter.get(
  "/subjects-with-counts",
  auth,
  parentController.getSubjectsWithTutorCounts,
);
...
adminRouter.post(
  "/disputes/:disputeId/message",
  adminAuth,
  adminController.addDisputeMessage,
);
adminRouter.put(
  "/disputes/:disputeId/priority",
  adminAuth,
  adminController.updateDisputePriority,
);
adminRouter.post(
  "/disputes/:disputeId/dismiss",
  adminAuth,
  adminController.dismissDispute,
);
